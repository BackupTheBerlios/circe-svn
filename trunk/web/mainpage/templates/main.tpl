...
<br/>
A list of projected features can be found <a href="{$index}?page=features">here</a>.<br/>
<br/>
Currently the irc library is being worked on, and we expect an early version soon.<br/>